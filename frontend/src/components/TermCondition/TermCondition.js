    ...
    <div className="container mt-5">
      ...
      <div className="mx-4 mb-4">
        ...
        <p>
          ...
          shall manage your use of our website, Review Me accessible at [PUT
        ...
        <br />
        <h6 className="sub-title">Intellectual Property Rights</h6>
        <hr />
        <p>
          Other than the content you own, under these Terms, Read Me and/or its
        ...
        <br />
        <h6 className="sub-title">Restrictions</h6>
        <hr />
        ...
        <p>
          ...
          and Read Me may further restrict access by you to any areas of this
        ...
        <br />
        <h6 className="sub-title">Your Content</h6>
        <hr />
        <p>
          In these Website Standard Terms and Conditions, "Your Content" shall
          mean any audio, video, text, images or other material you choose to
          display on this Website. By displaying Your Content, you grant Read Me
          ...
          third-party’s rights. Read Me reserves the right to remove any of Your
          Content from this Website at any time without notice.
        </p>
        <br />
        <h6 className="sub-title">No warranties</h6>
        <hr />
        <p>
          This Website is provided "as is," with all faults, and Read Me express
        ...
        <br />
        <h6 className="sub-title">Limitation of liability</h6>
        <hr />
        <p>
          In no event shall Read Me, nor any of its officers, directors and
          ...
          under contract. Read Me, including its officers, directors and
        ...
        <br />
        <h6 className="sub-title">Indemnification</h6>
        <hr />
        <p>
          You hereby indemnify to the fullest extent Read Me from and against
        ...
        <br />
        <h6 className="sub-title">Severability</h6>
        <hr />
        <p>
        ...
        <br />
        <h6 className="sub-title">Variation of Terms</h6>
        <hr />
        <p>
          Read Me is permitted to revise these Terms at any time as it sees fit,
          and by using this Website you are expected to review these Terms on a
          regular basis.
        </p>
        <br />
        <h6 className="sub-title">Assignment</h6>
        <hr />
        <p>
          The Read Me is allowed to assign, transfer, and subcontract its rights
        ...
        <br />
        <h6 className="sub-title">Entire Agreement</h6>
        <hr />
        <p>
          These Terms constitute the entire agreement between Read Me and you in
